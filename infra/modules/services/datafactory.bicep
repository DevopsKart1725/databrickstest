...
param rawDataLakeStorageId string = ''

param repoConfiguration object = {
  projectName: 'SyNeos Analytics Platform'
  repositoryName: 'data-product-provisioning'
...
// Variables
var keyVault001Name = any(length(split(keyVault001Id, '/')) >= 9 ? last(split(keyVault001Id, '/')) : 'incorrectSegmentLength')
// var rawDataLakeId = '/subscriptions/d9f56f19-917a-4893-883e-1a93932f741b/resourceGroups/iepdlz01-dev-storage/providers/Microsoft.Storage/storageAccounts/iepdlz01devraw'
var rawDataLakeName = 'raw_data_lake'
// var rawDataLakeSA = 'iepdlz01devraw'
var rawDataLakeSA = substring(rawDataLakeStorageId, lastIndexOf(rawDataLakeStorageId, '/'))
...
resource datafactory 'Microsoft.DataFactory/factories@2018-06-01' = {
  ...
  properties: {
    ...
    repoConfiguration: empty(repoConfiguration) ? {} : {
      accountName: repoConfiguration.accountName
      repositoryName: repoConfiguration.repositoryName
      collaborationBranch: repoConfiguration.collaborationBranch
...
resource rawDataLakeManagedPrivateEndpoint 'Microsoft.DataFactory/factories/managedVirtualNetworks/managedPrivateEndpoints@2018-06-01' = {
  parent: datafactoryManagedVirtualNetwork
  name: replace(rawDataLakeName, '-', '')
  properties: {
    fqdns: []
    groupId: 'dfs'
    privateLinkResourceId: rawDataLakeStorageId
  }
}

resource rawDataLakeLinkedService 'Microsoft.DataFactory/factories/linkedservices@2018-06-01' = {
  parent: datafactory
  name: replace(rawDataLakeName, '-', '')
  properties: {
    type: 'AzureBlobFS'
    ...
    parameters: {}
    typeProperties: {
      url: 'https://${rawDataLakeSA}.dfs.core.windows.net/'
    }
  }
}
...
output dataFactoryPrincipalType string = datafactory.identity.type
